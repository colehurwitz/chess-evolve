...
BUILDER_PROMPT = (
    "You are a chess move selector. You will receive the current board position "
    "and the analyst's move recommendation.\n\n"
    "Read the board position from {project_path}/.factory/chess/board_state.md\n"
    "Read the analyst's recommendation from "
    "{project_path}/.factory/chess/analysis.md\n\n"
    "Pick the best legal move based on the position and the analyst's advice.\n\n"
